...
- Swagger 是一个规范和完整的**框架，用于生成、描述、调用和可视化 RESTful 风格的 Web 服务**。功能主要包含以下几点:
...
- 这个swapper需要代码运行起来才能使用，所以我们需要使用一个Yapi可以理解为将swapper中的接口文档持久化，当swapper打开以后将swapper的接口文档信息导入到YApi，这样即使swapper关闭了我们也是可以看到这个接口文档的通过YApi
