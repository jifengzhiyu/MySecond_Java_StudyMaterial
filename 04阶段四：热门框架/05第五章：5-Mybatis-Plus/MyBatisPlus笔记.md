...
- 常用注解：==@Data==，为当前实体类在编译期设置对应的get/set方法，无参构造方法，toString方法，hashCode方法，equals方法等
...
- 相关属性
    ...
    - ASSIGN_ID 没有手动定义id值，就会自动指定雪花算法的id

![iShot2023-01-24 18.00.49](assets/iShot2023-01-24%2018.00.49.png)
